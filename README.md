...
O **Projeto Portfólio Pessoal** é um **site profissional moderno**, desenvolvido com **HTML, CSS e JavaScript**, com o objetivo de apresentar informações sobre mim, meus projetos e formas de contato de maneira clara, interativa e responsiva.
...
🔗 https://github.com/JhonatanMiranda221/projeto_portfolio_pessoal

------

## Contribuições

Contribuições são bem-vindas. Caso tenha sugestões de melhorias, correções ou novas funcionalidades, sinta-se à vontade para abrir uma **issue** ou enviar um **pull request**.# Portfolio
